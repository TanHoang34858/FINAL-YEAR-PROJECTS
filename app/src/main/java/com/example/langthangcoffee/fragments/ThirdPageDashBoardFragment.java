...
public class ThirdPageDashBoardFragment extends Fragment implements View.OnClickListener {
    ...
    private List<Food> getListFood() {
        ...
        //cafe
        list.add(new Food(R.drawable.cf1,"Black coffee","25000 đ",Food.TYPE_CAFE));
        list.add(new Food(R.drawable.cf2,"Milk coffee","25000 đ",Food.TYPE_CAFE));
        list.add(new Food(R.drawable.cf3,"Coconut coffee","25000 đ",Food.TYPE_CAFE));
        list.add(new Food(R.drawable.cf4,"Cheese coffee","25000 đ",Food.TYPE_CAFE));
        list.add(new Food(R.drawable.cf5,"Milo","25000 đ",Food.TYPE_CAFE));
        //tra sua
        list.add(new Food(R.drawable.ts1,"Black sugar milk tea","25000 đ",Food.TYPE_TRASUA));
        list.add(new Food(R.drawable.ts2,"Matcha milk tea","25000 đ",Food.TYPE_TRASUA));
        list.add(new Food(R.drawable.ts3,"Taro milk tea","25000 đ",Food.TYPE_TRASUA));
        list.add(new Food(R.drawable.ts4,"Cheese milk tea","25000 đ",Food.TYPE_TRASUA));
        list.add(new Food(R.drawable.ts5,"Cocoa milk tea","25000 đ",Food.TYPE_TRASUA));
        //fruit juice
        list.add(new Food(R.drawable.sd1,"Peach juice","30000 đ",Food.TYPE_SODA));
        list.add(new Food(R.drawable.sd2,"Grape juice","30000 đ",Food.TYPE_SODA));
        list.add(new Food(R.drawable.sd3,"Strawberry juice","30000 đ",Food.TYPE_SODA));
        list.add(new Food(R.drawable.sd4,"Lemon juice","30000 đ",Food.TYPE_SODA));
        list.add(new Food(R.drawable.sd5,"Orange juice","30000 đ",Food.TYPE_SODA));
