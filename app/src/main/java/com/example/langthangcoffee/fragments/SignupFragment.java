        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!chkChinhSach.isChecked() || !chkChuongTrinhThanhVien.isChecked()) {
                    Toast.makeText(getActivity(), "Please accept the policies", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(getActivity(), "Last name must be 2 characters or more", Toast.LENGTH_SHORT).show();
                } else if (edtTenKH.getText().toString().trim().length() < 2) {
                    Toast.makeText(getActivity(), "Name must be 2 characters or more", Toast.LENGTH_SHORT).show();
                } else {
                    signupTaiKhoan();
                }
            }
