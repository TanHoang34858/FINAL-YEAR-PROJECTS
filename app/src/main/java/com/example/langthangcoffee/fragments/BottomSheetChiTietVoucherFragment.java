    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvSaoChep.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ClipData clip = ClipData.newPlainText("Voucher Code", voucher.getMaVoucher());
                clipboard.setPrimaryClip(clip);
                Toast.makeText(mainActivity, "Copy successfully", Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            String thoiGianHetHan = "Expires in " + days + " day " +  hours + " hour " + minutes + " minute";
