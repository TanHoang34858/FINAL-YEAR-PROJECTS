...
public class ThemTaiKhoanFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        quyenHanArrayList.add(new QuyenHan(1, "Customer"));
        quyenHanArrayList.add(new QuyenHan(2, "Admin"));
        ...
        btnThemTaiKhoan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Confirm additional accounts");
                builder.setMessage("Are you sure you want to add a new account?");
