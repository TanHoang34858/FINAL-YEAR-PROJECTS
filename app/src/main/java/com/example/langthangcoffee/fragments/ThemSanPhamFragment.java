...
public class ThemSanPhamFragment extends Fragment implements FoodOrderToppingAdapter.EventListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        danhMucSanPhamArrayList.add(new DanhMucSanPham(1, "Coffee"));
        danhMucSanPhamArrayList.add(new DanhMucSanPham(2, "Fruit juice"));
        danhMucSanPhamArrayList.add(new DanhMucSanPham(3, "Milk tea"));
        danhMucSanPhamArrayList.add(new DanhMucSanPham(4, "Cake"));
        ...
        btnThemSanPham.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Confirm more products");
                builder.setMessage("Are you sure you want to add a new product to this product??");
