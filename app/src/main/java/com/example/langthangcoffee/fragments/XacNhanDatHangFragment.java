...
public class XacNhanDatHangFragment extends Fragment {
        ...
        btnConfirmOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (lichSuOrderList.size() == 0) {
                    Toast.makeText(getActivity(), "Please order at least one item", Toast.LENGTH_SHORT).show();
                } else if (donHang.getDiaChiGiaoHang() == null || donHang.getDiaChiGiaoHang().isEmpty()) {
                    Toast.makeText(getActivity(), "Please fill in your delivery address", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void updateTinhTrangDonHang() {
        try {
            ...
            // Update order status from initialization -> waiting for confirmation
    ...
    public void updateDonHangView() {
        if (donHang != null) {
            ...
            tvVoucher.setText(donHang.getMaVoucher().isEmpty() ? "Do not have" : donHang.getMaVoucher());
        }
