...
public class QuanLyTaiKhoanAdapter extends RecyclerView.Adapter<QuanLyTaiKhoanAdapter.FoodOrderViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final FoodOrderViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.tvHoTen.setText("First and last name: " + taiKhoan.getHo() + " " + taiKhoan.getTen());
        holder.tvThoiGianThamGia.setText("Join: " + taiKhoan.getThoiGianThamGia());
        holder.tvSoDienThoai.setText("Participation time: " + taiKhoan.getSdtTaiKhoan());
        holder.tvTenQuyenHan.setText("Classify: " + taiKhoan.getTenQuyenHan());
