...
public class QuanLyLoaiVoucherAdapter extends RecyclerView.Adapter<QuanLyLoaiVoucherAdapter.FoodOrderViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final FoodOrderViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.tvTongTien.setText("Reduced to money: " + String.valueOf(loaiVoucher.getTongTien()) + "%");
        holder.tvPhiShip.setText("Reduce delivery costs: " + String.valueOf(loaiVoucher.getPhiShip()) + "%");
        holder.tvSoLuongToiThieu.setText("Minimum number of items: " + String.valueOf(loaiVoucher.getSoLuongToiThieu()));
        Picasso.get()
